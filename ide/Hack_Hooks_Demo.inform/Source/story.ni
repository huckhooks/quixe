...
The Hack hooks demo is a room. 
"You are in a deep cave where a little wizard of code changed the world.
Only a little wizard, and only a little bit.
But now walkhalftroughs can be transfered and tried by copypasting urls.
...
The testing foo is here. 
The description is "A little [item described].
First thing the Wizard drops in a new project. It is looking for a bar."
...
The linkbox is here. "A [item described] stands here.".
Understand "links", "links" and "box" as linkbox.

The original quixe url is in the linkbox. The description is 
"[item described]. Popup: http://eblong.com/zarf/glulx/quixe/".

The custom quixe url is in the linkbox. The description is 
"The [item described]. Popup: https://github.com/huckhooks/quixe".

The inform7 url is in the linkbox. The description is 
"the [item described]. Popup: http://inform7.com/"

The original parchment-proxy url is in the linkbox. The description is 
"[item described]. Popup: http://zcode.appspot.com/".

The Hucks quixe-clone url is in the linkbox. The description is
"the [item described]. Popup: https://github.com/huckhooks/quixe".

The Hucks proxy-clone url is in the linkbox. The description is 
...
The featurelist of the bookmark history is here. "And a [item described].". 
Understand "feature", "features" and "list" as featurelist.

The url bar is in the featurelist. 
The description is "If you look carefully at the url in your real browser,
you see weird chars behind the '#'"

The back button is in the featurelist. 
The description is "If you press this button in your real browser,
you can go back one step."

The copy paste is in the featurelist. The description is 
"If you copy the url and paste it in another browser,
it will go to where you are now."

The title is in the featurelist. The Description is 
...
The browsie in an iframe is in the demos. The description is 
"A [item described]. IFrame: 10em, about_browsies.html"

The browsie in a popup is in the demos. The description is 
"A [item described]. Popup: about_browsies.html"

The browsie in this window is in the demos. The Description is 
"A [item described]. Browse: about_browsies.html"

The crazy compass is in the demos. The description is 
...
"A door leads [direction of the item described from the location]
to the [other side].".
...
When play begins: now the right hand status line is "{look}".
...
The toolbox door  is a simple door. 
It is north of the Hack hooks demo and south of the Toolbox.
